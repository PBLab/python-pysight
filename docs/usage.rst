...
3. For batch processing of multiple list files::
    ...
    cfg_fname: str = r'/path/to/existing/cfg.toml'

    data_record = pysight.main.run_batch_lst(foldername=foldername, globstr=globstr,
...
4. For parallel execution of multiple list files::
    ...
    data_record = pysight.main.mp_batch(foldername=foldername, globstr=globstr,
